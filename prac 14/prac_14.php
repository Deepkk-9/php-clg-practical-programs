...
<body>
    <form class="card p-3" style="width: 20% !important;" method="post" action="./prac_14.php">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="exampleFormControlInput1" value="From: kawaledeep9@gmail.com" disabled>
        </div>
        ...
        if (isset($_POST['to']) && $_POST['sub']) {
            ...
            $sub = $_POST['sub'];
            $desc = $_POST['desc'];
            $from = "From: kawaledeep9@gmail.com";
